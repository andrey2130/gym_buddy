...
@override
String toString() {
  return 'ExerciseModel(exerciseId: $exerciseId, name: $name, sets: $sets, createdAt: $createdAt)';
}
...
as List<SetModel>,createdAt: freezed == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime?,
  ));
}
