...
mixin _$WorkoutEntity {
 ...
 String get workoutId; String get userId; DateTime get date; List<ExerciseEntity> get exercises; int? get duration; String? get notes; DateTime? get createdAt; DateTime? get updatedAt; bool get isCompleted;
...
@override
String toString() {
  return 'WorkoutEntity(workoutId: $workoutId, userId: $userId, date: $date, exercises: $exercises, duration: $duration, notes: $notes, createdAt: $createdAt, updatedAt: $updatedAt, isCompleted: $isCompleted)';
}
...
@useResult
$Res call({
 String workoutId, String userId, DateTime date, List<ExerciseEntity> exercises, int? duration, String? notes, DateTime? createdAt, DateTime? updatedAt, bool isCompleted
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String workoutId,  String userId,  DateTime date,  List<ExerciseEntity> exercises,  int? duration,  String? notes,  DateTime? createdAt,  DateTime? updatedAt,  bool isCompleted)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WorkoutEntity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String workoutId,  String userId,  DateTime date,  List<ExerciseEntity> exercises,  int? duration,  String? notes,  DateTime? createdAt,  DateTime? updatedAt,  bool isCompleted)  $default,) {final _that = this;
switch (_that) {
case _WorkoutEntity():
return $default(_that.workoutId,_that.userId,_that.date,_that.exercises,_that.duration,_that.notes,_that.createdAt,_that.updatedAt,_that.isCompleted);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String workoutId,  String userId,  DateTime date,  List<ExerciseEntity> exercises,  int? duration,  String? notes,  DateTime? createdAt,  DateTime? updatedAt,  bool isCompleted)?  $default,) {final _that = this;
switch (_that) {
case _WorkoutEntity() when $default != null:
return $default(_that.workoutId,_that.userId,_that.date,_that.exercises,_that.duration,_that.notes,_that.createdAt,_that.updatedAt,_that.isCompleted);case _:
  return null;
...
class _WorkoutEntity implements WorkoutEntity {
  const _WorkoutEntity({required this.workoutId, required this.userId, required this.date, required final  List<ExerciseEntity> exercises, this.duration, this.notes, this.createdAt, this.updatedAt, this.isCompleted = false}): _exercises = exercises;
